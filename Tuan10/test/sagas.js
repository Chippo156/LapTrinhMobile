...
function* fetchDataSaga() {
    try {
        const response = yield call(axios.get, 'https://66fc8f39c3a184a84d174f4d.mockapi.io/Item');
...
function* createDataSaga(action) {
    try {
        const response = yield call(axios.post, 'https://66fc8f39c3a184a84d174f4d.mockapi.io/Item', action.payload);
...
function* updateDataSaga(action) {
    try {
        const response = yield call(axios.put, `https://66fc8f39c3a184a84d174f4d.mockapi.io/Item/${action.payload.id}`, action.payload.data);
...
function* deleteDataSaga(action) {
    try {
        yield call(axios.delete, `https://66fc8f39c3a184a84d174f4d.mockapi.io/Item/${action.payload}`);
